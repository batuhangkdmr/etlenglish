  ...
  return (
    <div className="relative z-10 mx-auto w-full max-w-[620px] lg:mx-0 lg:justify-self-end">
      ...
      <motion.div
        ...
        className="absolute -top-8 left-0 w-36 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-soft sm:w-44"
      >
      ...
      <motion.div
        ...
        className="absolute right-0 -bottom-5 flex items-center gap-3 rounded-2xl border border-white/80 bg-white/95 p-3.5 shadow-soft sm:right-2 sm:p-4"
      >
